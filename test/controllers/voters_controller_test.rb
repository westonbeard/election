...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { address: @voter.address, city: @voter.city, first_name: @voter.first_name, last_name: @voter.last_name, state: @voter.state, zip: @voter.zip }
    end
  ...
  test "should update voter" do
    patch :update, id: @voter, voter: { address: @voter.address, city: @voter.city, first_name: @voter.first_name, last_name: @voter.last_name, state: @voter.state, zip: @voter.zip }
    assert_redirected_to voter_path(assigns(:voter))
  end
